...
namespace nl.ChessOnline
{
    public class ChessManager
    {
        ...
        public List<PieceActionData> actionHistory;
        ...
        public ChessManager()
        {
            ...
            actionHistory = new List<PieceActionData>(256);
        ...
        private PieceActionData PeekHistory()
        {
        ...
        public GameState UpdateGameState()
        {
            ...
            PieceActionData latestActionOrNull = PeekHistory();
            ...
            for (int y = 0; y < 8; ++y)
                for (int x = 0; x < 8; ++x)
                {
                    ...
                    List<PieceActionData> actions = attackerPiece.nextActions;
        ...
        #region Generating PieceActionData
        ...
        private void m_GeneratePawnAction(CellData _cellData)
        {
            ...
            List<PieceActionData> nextActions = piece.nextActions;
            ...
            {
                nextActions.Add(PieceActionData.GetMoveAction(sx, sy, vFront1.x, vFront1.y));

                if (piece.movedCount == 0 && this.IsEmptyCell(vFront2))
                {
                    PieceActionData actFront2 = PieceActionData.GetMoveAction(sx, sy, vFront2.x, vFront2.y);
            ...
            if (this.IsValidPosition(vDiag1) && this.IsEnemyPiece(vOrigin, vDiag1))
                nextActions.Add(PieceActionData.GetCatchAction(sx, sy, vDiag1.x, vDiag1.y));

            if (this.IsValidPosition(vDiag2) && this.IsEnemyPiece(vOrigin, vDiag2))
                nextActions.Add(PieceActionData.GetCatchAction(sx, sy, vDiag2.x, vDiag2.y));
            ...
            {
                nextActions.Add(PieceActionData.GetEnPassantAction(sx, sy, vSide1.x, vSide1.y, axis));
            }
            ...
            {
                nextActions.Add(PieceActionData.GetEnPassantAction(sx, sy, vSide2.x, vSide2.y, axis));
            }
        }
        ...
        private int m_GenerateCellAction(CellData _cellData, IntVector2 _deltaPosition)
        {
            ...
            {
                nextActions.Add(PieceActionData.GetCatchAction(vOrigin.x, vOrigin.y, vNext.x, vNext.y));
                return 1;
            }
            else
            {
                nextActions.Add(PieceActionData.GetMoveAction(vOrigin.x, vOrigin.y, vNext.x, vNext.y));
                return 0;
            }
        }
        ...
        #region Handling Piece by PieceActionData
        private void m_DoPieceAction(PieceActionData _prevAction, PieceActionData _currentAction)
        {
        ...
        private void m_UndoPieceAction(PieceActionData _lastActionOrNull, PieceActionData _undidAction)
        {
        ...
        private void m_SetPawnSpecialStarts(PieceActionData _pieceActionData)
        {
            if (!_pieceActionData.isSpecialStartedPawn)
            {
                latestSpecialStartedPawnOrNull = null;
                return;
            }

            int dx = _pieceActionData.posDestination.x;
            int dy = _pieceActionData.posDestination.y;

            latestSpecialStartedPawnOrNull = chessBoard[dx, dy].piece;
        }

        private void m_DoPieceMove(PieceActionData _pieceActionData)
        {
            int sx = _pieceActionData.posSource.x;
            int sy = _pieceActionData.posSource.y;
            int dx = _pieceActionData.posDestination.x;
            int dy = _pieceActionData.posDestination.y;
        ...
        private void m_UndoPieceMove(PieceActionData _pieceActionData)
        {
            int sx = _pieceActionData.posSource.x;
            int sy = _pieceActionData.posSource.y;
            int dx = _pieceActionData.posDestination.x;
        ...
        private void m_DoPieceCatch(PieceActionData _pieceActionData)
        {
            int sx = _pieceActionData.posSource.x;
            int sy = _pieceActionData.posSource.y;
            int dx = _pieceActionData.posDestination.x;
        ...
        private void m_UndoPieceCatch(PieceActionData _pieceActionData)
        {
            int sx = _pieceActionData.posSource.x;
            int sy = _pieceActionData.posSource.y;
            int dx = _pieceActionData.posDestination.x;
        ...
        private void m_DoPieceCastling(PieceActionData _pieceActionData)
        {
            int rx = _pieceActionData.posRepresentative.x;
            int ry = _pieceActionData.posRepresentative.y;
            int sx = _pieceActionData.posSource.x;
            int sy = _pieceActionData.posSource.y;
            int dx = _pieceActionData.posDestination.x;
            int dy = _pieceActionData.posDestination.y;
        ...
        private void m_UndoPieceCastling(PieceActionData _pieceActionData)
        {
            int rx = _pieceActionData.posRepresentative.x;
            int ry = _pieceActionData.posRepresentative.y;
            int sx = _pieceActionData.posSource.x;
        ...
        private void m_DoPieceEnPassant(PieceActionData _pieceActionData)
        {
            int rx = _pieceActionData.posRepresentative.x;
            int ry = _pieceActionData.posRepresentative.y;
            int sx = _pieceActionData.posSource.x;
        ...
        private void m_UndoPieceEnPassant(PieceActionData _pieceActionData)
        {
            int rx = _pieceActionData.posRepresentative.x;
            int ry = _pieceActionData.posRepresentative.y;
            int sx = _pieceActionData.posSource.x;
        ...
        public void Move(int _positionX, int _positionY, int _idxNextAction)
        {
            ...
            PieceActionData latestActionOrNull = PeekHistory();
            PieceActionData action = cellData.piece.nextActions[_idxNextAction];
